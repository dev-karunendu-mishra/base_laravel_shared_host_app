...
>
    <head>
        ...
        <link
            rel="icon"
            type="image/x-icon"
            href="/assets/dashboard/img/favicon/favicon.ico"
        />
        ...
        <link
            rel="stylesheet"
            href="/assets/dashboard/vendor/fonts/boxicons.css"
        />
        <link
            rel="stylesheet"
            href="/assets/dashboard/vendor/fonts/fontawesome.css"
        />
        <link
            rel="stylesheet"
            href="/assets/dashboard/vendor/fonts/flag-icons.css"
        />

        <!-- Core CSS -->
        <link
            rel="stylesheet"
            href="/assets/dashboard/vendor/css/rtl/core.css"
        ...
        <link
            rel="stylesheet"
            href="/assets/dashboard/vendor/libs/perfect-scrollbar/perfect-scrollbar.css"
        />
        <link
            rel="stylesheet"
            href="/assets/dashboard/vendor/libs/typeahead-js/typeahead.css"
        />
        <!-- Vendor -->
        <link
            rel="stylesheet"
            href="/assets/dashboard/vendor/libs/%40form-validation/form-validation.css"
        />
    ...
    <body>
        ...
        <!-- Page JS -->
        <script src="/assets/dashboard/js/pages-auth.js"></script>
    </body>
</html>
