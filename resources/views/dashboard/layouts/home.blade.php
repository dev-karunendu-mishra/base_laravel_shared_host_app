                ...
                <div class="d-flex align-items-start row">
                    ...
                    <div class="col-sm-5 text-center text-sm-left">
                        <div class="card-body pb-0 px-0 px-md-6">
                            <img src="/assets/dashboard/img/illustrations/man-with-laptop.png" height="175"
                        ...
                        <div class="card-body">
                            <div class="card-title d-flex align-items-start justify-content-between mb-4">
                                <div class="avatar flex-shrink-0">
                                    <img src="/assets/dashboard/img/icons/unicons/wallet-info.png" alt="wallet info"
                                        class="rounded">
                                </div>
                                <div class="dropdown">
                ...
                <div class="col-6 mb-6">
                    <div class="card h-100">
                        <div class="card-body">
                            <div class="card-title d-flex align-items-start justify-content-between mb-4">
                                <div class="avatar flex-shrink-0">
                                    <img src="/assets/dashboard/img/icons/unicons/paypal.png" alt="paypal"
                                        class="rounded">
                                </div>
                                <div class="dropdown">
                    ...
                    <div class="tab-content p-0">
                        <div class="tab-pane fade show active" id="navs-tabs-line-card-income" role="tabpanel">
                            <div class="d-flex mb-6">
                                <div class="avatar flex-shrink-0 me-3">
                                    <img src="/assets/dashboard/img/icons/unicons/wallet-primary.png" alt="User">
                                </div>
                                <div>
            ...
            <div class="card h-100">
                ...
                <div class="card-body pt-4">
                    <ul class="p-0 m-0">
                        ...
                        <li class="d-flex align-items-center mb-6">
                            <div class="avatar flex-shrink-0 me-3">
                                <img src="/assets/dashboard/img/icons/unicons/cc-primary.png" alt="User"
                                    class="rounded">
                            </div>
                            <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                <div class="me-2">
                        ...
                        <li class="d-flex align-items-center">
                            <div class="avatar flex-shrink-0 me-3">
                                <img src="/assets/dashboard/img/icons/unicons/cc-warning.png" alt="User"
                                    class="rounded">
                            </div>
                            <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                <div class="me-2">
        ...
        <div class="col-md-12 col-lg-6 order-4 order-lg-3">
            <div class="card h-100">
                <div class="card-header d-flex justify-content-between">
                    ...
                    <div class="dropdown">
                        <button class="btn text-muted p-0" type="button" id="timelineWapper" data-bs-toggle="dropdown"
                            aria-haspopup="true" aria-expanded="false">
                            <i class="bx bx-dots-vertical-rounded bx-lg"></i>
                        </button>
                            ...
                            <div class="timeline-event">
                                ...
                                <div class="d-flex align-items-center mb-1">
                                    <div class="badge bg-lighter rounded-2">
                                        <img src="/assets/dashboard/img/icons/misc/pdf.png" alt="img" width="15"
                                            class="me-2">
                                ...
                                <div class="d-flex justify-content-between flex-wrap gap-2">
                                    <div class="d-flex flex-wrap align-items-center">
                                        <div class="avatar avatar-sm me-2">
                                            <img src="/assets/dashboard/img/avatars/1.png" alt="Avatar"
                                            ...
                                            <ul
                                                ...
                                                <li data-bs-toggle="tooltip" data-popup="tooltip-custom"
                                                    ...
                                                    <img class="rounded-circle"
                                                        src="/assets/dashboard/img/avatars/5.png" alt="Avatar">
                                                </li>
                                                <li data-bs-toggle="tooltip" data-popup="tooltip-custom"
                                                    data-bs-placement="top" title="Allen Rieske" class="avatar pull-up">
                                                    <img class="rounded-circle"
                                                        src="/assets/dashboard/img/avatars/12.png" alt="Avatar">
                                                </li>
                                                <li data-bs-toggle="tooltip" data-popup="tooltip-custom"
                                                    data-bs-placement="top" title="Julee Rossignol"
                                                    class="avatar pull-up">
                                                    <img class="rounded-circle"
                                                        src="/assets/dashboard/img/avatars/6.png" alt="Avatar">
                                                </li>
                                                <li class="avatar">
                            ...
                            <table class="table table-borderless">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="/assets/dashboard/img/icons/brands/chrome.png" alt="Chrome"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="/assets/dashboard/img/icons/brands/safari.png" alt="Safari"
                                                    height="24" class="me-3">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="/assets/dashboard/img/icons/brands/firefox.png" alt="Firefox"
                                                    height="24" class="me-3">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="/assets/dashboard/img/icons/brands/edge.png" alt="Edge"
                                                    height="24" class="me-3">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="/assets/dashboard/img/icons/brands/opera.png" alt="Opera"
                                                    height="24" class="me-3">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="/assets/dashboard/img/icons/brands/uc.png" alt="uc"
                                                    height="24" class="me-3">
                            ...
                            <table class="table table-borderless">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="/assets/dashboard/img/icons/brands/windows.png" alt="Windows"
                                                    height="24" class="me-3">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="/assets/dashboard/img/icons/brands/mac.png" alt="Mac"
                                                    height="24" class="me-3">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="/assets/dashboard/img/icons/brands/ubuntu.png" alt="Ubuntu"
                                                    height="24" class="me-3">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="/assets/dashboard/img/icons/brands/cent.png" alt="Cent"
                                                    height="24" class="me-3">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="/assets/dashboard/img/icons/brands/linux.png" alt="linux"
                                                    height="24" class="me-3">
