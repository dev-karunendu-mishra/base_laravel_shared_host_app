<x-app-layout>
    @push('styles')
    <link rel="stylesheet" href="/assets/dashboard/vendor/css/pages/app-calendar.css">
    @endpush
    ...
    @push('scripts')
    <script src="/assets/dashboard/js/app-calendar-events.js"></script>
    <script src="/assets/dashboard/js/app-calendar.js"></script>
    @endpush
</x-app-layout>